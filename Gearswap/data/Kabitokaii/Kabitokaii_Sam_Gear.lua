...
function user_job_setup()
  ...
  state.Weapons:options('Default', 'Shoha', 'Koki', 'Jinpu', 'Fudo', 'ImpulseDrive', 'ProcWeapon', 'NamasRanged')
...
function init_gear_sets()
  ...
  sets.precast.JA['Hagakure'] = { body = "Sakonji Domaru +3" }
  ...
  sets.precast.WS.Acc = set_combine(sets.precast.WS,
    { head = "Wakido Kabuto +3", body = "Sakonji Domaru +3", feet = "Wakido Sune. +3" })
  ...
  -- Weapons sets
  sets.weapons.Default = { main = "Dojikiri Yasutsuna" }
  sets.weapons.Shoha = { main = "Dojikiri Yasutsuna", sub = "Khonsu" }
  sets.weapons.Koki = { main = "Dojikiri Yasutsuna", sub = "Utu Grip" }
  sets.weapons.Jinpu = { main = "Dojikiri Yasutsuna", sub = "Utu Grip" }
  sets.weapons.Fudo = { main = "Masamune", sub = "Utu Grip" }
  sets.weapons.ImpulseDrive = { main = "Shining One", sub = "Khonsu" }
  sets.weapons.ProcWeapon = { main = "Norifusa +1", sub = "Bloodrain Strap" }
  sets.weapons.NamasRanged = { range = "Yoichinoyumi", ammo = "Eminent Arrow" }
...
autows_list = { ['Shoha'] = 'Tachi: Shoha', ['Koki'] = 'Tachi: Koki', ['Jinpu'] = 'Tachi: Jinpu', ['Fudo'] = 'Tachi: Fudo', ['ImpulseDrive'] = 'Impulse Drive', ['NamasRanged'] = 'Namas Arrow' }
