...
function user_job_setup()
  ...
  state.Weapons:options('Default', 'Ranged', 'Savage', 'Evisceration', 'DualWeapons', 'DualEvisceration',
    'DualLeadenRanged', 'DualSavageWeapons', 'DualLeadenRanged', 'DualLeadenMelee', 'DualAeolian', 'DualLeadenMeleeAcc',
    'DualRanged', 'DualProcWeapons', 'None')
...
function init_gear_sets()
  ...
  "Floral Gauntlets", waist = "Reiki Yotai" }

  -- Weapons sets
  sets.weapons.DualSavageWeapons = { main = "Naegling", sub = { name = "Gleti's Knife", augments = { 'Path: A', } }, range =
  "Anarchy +2" }
  sets.weapons.DualLeadenRanged = { main = "Rostam", sub = "Tauret", range = "Death Penalty" }
  sets.weapons.DualLeadenMelee = { main = "Naegling", sub = { name = "Gleti's Knife", augments = { 'Path: A', } }, range =
  "Death Penalty" }
  ...
  sets.weapons.DualWeapons = { main = "Naegling", sub = { name = "Gleti's Knife", augments = { 'Path: A', } }, range =
  "Death Penalty" }
...
autows_list = { ['Default'] = 'Savage Blade', ['Evisceration'] = 'Evisceration', ['Savage'] = 'Savage Blade', ['Ranged'] =
'Last Stand', ['DualWeapons'] = 'Savage Blade', ['DualSavageWeapons'] = 'Savage Blade', ['DualEvisceration'] =
'Evisceration', ['DualLeadenRanged'] = 'Leaden Salute', ['DualLeadenMelee'] = 'Leaden Salute', ['DualAeolian'] =
'Aeolian Edge', ['DualRanged'] = 'Last Stand' }
