...
function user_setup()
    ...
    state.Gun = M{['description']='Gun', 'Holliday', 'Compensator', 'Anarchy +2'}
    state.WeaponSet = M{['description']='Melee', 'Piercing', 'Slashing', 'Ranged'}
    -- state.CP = M(false, "Capacity Points Mode")
    state.WeaponLock = M(false, 'Weapon Lock')

    gear.RAbullet = "Titanium Bullet"
    gear.RAccbullet = "Titanium Bullet"
    gear.WSbullet = "Titanium Bullet"
    gear.MAbullet = "Titanium Bullet"
    gear.QDbullet = "Titanium Bullet"
...
function init_gear_sets()
    ...
    sets.Piercing = {main={ name="Rostam", augments={'Path: C',}, sub="Blurred Knife +1"}}
    sets.Slashing = {main="Eletta Sword", sub={name="Rostam", augments={'Path: C',}}}
    sets.Ranged = {main="Rostam", sub="Blurred Knife +1"}
