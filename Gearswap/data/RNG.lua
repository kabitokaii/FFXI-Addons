...
function job_setup()
  ...
  init_job_states(
  { "Capacity", "AutoRuneMode", "AutoTrustMode", "AutoWSMode", "AutoShadowMode", "AutoFoodMode", "RngHelper",
    "AutoStunMode", "AutoDefenseMode", },
    { "AutoBuffMode", "AutoSambaMode", "Weapons", "OffenseMode", "RangedMode", "WeaponskillMode", "IdleMode", "Passive",
...
function check_ammo_precast(spell, action, spellMap, eventArgs)
  ...
  if count_available_ammo(player.equipment.ammo) < 15 then
    add_to_chat(122,
      ...
      "' running low: (" .. count_available_ammo(player.equipment.ammo) .. ") remaining.")
  end
end
