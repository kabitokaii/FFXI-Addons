...
function init_gear_sets()
    ...
    sets.MagicBurst = {main="Mpaca's Staff",sub="Elder's Strap",head="Bunzi's hat",neck="Sanctity Necklace",body="Jhakri Robe +2",hands="Bunzi's Gloves",ring1="Jhakri Ring",legs="Bunzi's Pants",feet="Jhakri Pigaches +2"}
    ...
    sets.midcast.Cure = {main="Bunzi's Rod",sub="Sors Shield",range=empty,ammo="Hasty Pinion +1",
        ...
        back="Tempered Cape +1",waist="Luminary Sash",legs="Carmine Cuisses +1",feet="Kaykaus Boots +1"}
	...
	sets.midcast['Elemental Magic'] = {main="Mpaca's Staff",sub="Elder's Strap",head="Bunzi's hat",neck="Sanctity Necklace",body="Jhakri Robe +2",hands="Bunzi's Gloves",ring1="Jhakri Ring",ring2="Weather. Ring",legs="Bunzi's Pants",feet="Jhakri Pigaches +2",ear1="Regal Earring", ear2="Friomisi Earring"}
