...
function init_gear_sets()
    ...
    sets.precast.CorsairRoll = {main="Rostam",range="Compensator",
        ...
        body="Lanun Frac +3",hands="Chasseur's Gants +2",ring1="Barataria Ring",ring2="Dark Ring",
    ...
    sets.precast.WS['Savage Blade'] = {ammo=gear.WSbullet,
        ...
        body="Laksa. Frac +3",hands="Chasseur's Gants +2",ring1="Sroda Ring",ring2="Epaminondas's Ring",
